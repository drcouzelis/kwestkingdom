...
- init {
  ...
  if (self) {
    ...
    [grassAnimation addFrame: getImage(TERRAIN_GRASS_01_BMP)];
    [pathAnimation addFrame: getImage(TERRAIN_PATH_01_BMP)];
    [mountainAnimation addFrame: getImage(TERRAIN_TREE_01_BMP)];
