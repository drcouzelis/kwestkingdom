...
- init {
  ...
  if (self) {
    ...
    [standAnimation addFrame: getImage(NINJA_01_BMP)];
    [standAnimation addFrame: getImage(NINJA_02_BMP)];
    [standAnimation addFrame: getImage(NINJA_03_BMP)];
    [standAnimation addFrame: getImage(NINJA_02_BMP)];
    ...
    [attackAnimation addFrame: getImage(NINJA_01_BMP)];
    [attackAnimation addFrame: getImage(NINJA_02_BMP)];
    [attackAnimation addFrame: getImage(NINJA_02_BMP)];
    [attackAnimation addFrame: getImage(NINJA_03_BMP)];
    [attackAnimation addFrame: getImage(NINJA_03_BMP)];
    [attackAnimation addFrame: getImage(NINJA_02_BMP)];
    [attackAnimation addFrame: getImage(NINJA_02_BMP)];
